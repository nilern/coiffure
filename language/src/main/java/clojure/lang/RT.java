...
static{
	...
	/* HACK(nilern): Comment out: v = Var.intern(CLOJURE_NS, LOAD_FILE,
	               new AFn(){
		               public Object invoke(Object arg1) {
			               try
				               {
...
private synchronized static void doInit() {
	...
	try {
		...
		/* HACK(nilern): Comment out: maybeLoadResourceScript("user.clj");*/
...
static public ClassLoader baseLoader(){
	/* HACK(nilern): Comment out: if(Compiler.LOADER.isBound())
