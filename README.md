...
and transitively (because the hashing code was imported too):
...
Since the Clojure compiler was not imported (otherwise, what would be the point?), neither was the ASM bytecode library.
